...
const mockActivities: Activity[] = [
      {
        ...
        source: "Discord",
        type: "question",
        content: "What are the best practices for implementing React Server Components in a production environment?",
        reactions: 15,
        replies: 8,
      ...
      },
      {
        ...
        source: "Slack",
        type: "resource",
        content: "I've compiled a list of 50 open-source LLM datasets for fine-tuning. Here's the link: talentcircle.dev/datasets",
        reactions: 42,
        replies: 12,
      ...
      },
      {
        ...
        type: "post",
        content: "Had an amazing session today about Cloud Infrastructure. Thanks everyone for joining and sharing your setups!",
        reactions: 28,
        replies: 5,
    ...
    return (
        <Card className="rounded-[40px] border-none shadow-sm overflow-hidden flex flex-col">
            ...
            <CardContent className="flex-1 flex flex-col pt-0 px-8 pb-8">
                ...
                {mockActivities.length > 0 && (
                    <Button className="w-full mt-10 py-8 rounded-full font-bold uppercase tracking-[0.2em] text-[10px] shadow-xl hover:shadow-2xl transition-all gap-3">
